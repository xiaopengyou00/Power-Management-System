...
extern unsigned char USART_Start;		//串口接收标志
extern unsigned char USART_REC_Finish_FLAG;		//串口接收完成标志
extern unsigned char REC_Char[100];			//缓冲区
extern unsigned char CTR_STR2[100];			//串口收到Qt发来的数据
